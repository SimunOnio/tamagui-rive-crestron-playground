...
export const Installation = () => (
	<YStack width={"100%"} space>
		...
		<Paragraph maxWidth={600} textAlign={"center"} alignSelf={"center"}>
			...
			. As the project is in early phase please be assure that it can contain bugs and unexpected behaviour.
		</Paragraph>

		<Paragraph paddingRight={"$3"}>
			The main focus are form components with an easy integration of `react-hook-form`. The repo also tries to showcase
			best practices and give developers guidance on how to use Tamagui and the underlying eco-system.
		</Paragraph>
		<H3>Installation</H3>
		<Paragraph>
			First follow the{" "}
		...
		<Paragraph paddingRight={"$3"}>
			All components of this library are prefixed with a `Lm[ComponentName]`. To be more flexible and due to frequent
			changes of tamagui you have to install it along tamagui-extras.
		</Paragraph>
		<H5>Links</H5>
		<ul>
			<li>
